...
SUSY_HLT_MET_HT_MUON = cms.EDAnalyzer("SUSY_HLT_Muon_Hadronic",
  ...
  # TriggerPath = cms.string('HLT_Mu6_PFHT200_PFMET125_NoiseCleaned_v'),
  TriggerPath = cms.string('HLT_Mu6_PFHT200_PFMET125_JetIdCleaned_v'),
...
SUSY_HLT_MET_HT_MUON_FASTSIM = cms.EDAnalyzer("SUSY_HLT_Muon_Hadronic",
  trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'), #to use with test sample
  #trigSummary = cms.InputTag("hltTriggerSummaryAOD"),
  MuonCollection = cms.InputTag("muons"),
  pfMETCollection = cms.InputTag("pfMet"),
...
SUSY_HLT_MET_HT_MUON_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    # subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_Mu6_PFHT200_PFMET125_NoiseCleaned"),
    subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_Mu6_PFHT200_PFMET125_JetIdCleaned"),
...
SUSY_HLT_MET_HT_MUON_FASTSIM_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    #subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_Mu6_PFHT200_PFMET125_NoiseCleaned"),
    subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_Mu6_PFHT200_PFMET125_JetIdCleaned"),
    verbose        = cms.untracked.uint32(2), # Set to 2 for all messages
    resolution     = cms.vstring(""),
