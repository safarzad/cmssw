...
SUSY_HLT_MET_HT_MUON_BTAG = cms.EDAnalyzer("SUSY_HLT_Muon_Hadronic",
  ...
  TriggerPath = cms.string('HLT_Mu6_PFHT200_PFMET100_JetIdCleaned_BTagCSV07_v'),
...
SUSY_HLT_MET_HT_MUON_BTAG_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    ...
    subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_Mu6_PFHT200_PFMET100_JetIdCleaned_BTagCSV07"),
