...
SUSY_HLT_MET_MUON = cms.EDAnalyzer("SUSY_HLT_Muon_Hadronic",
  ...
  TriggerPath = cms.string('HLT_PFMET120_JetIdCleaned_Mu5_v'),
...
SUSY_HLT_MET_MUON_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    #subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_PFMET120_NoiseCleaned_Mu5"),
    subDirs        = cms.untracked.vstring("HLT/SUSYBSM/HLT_PFMET120_JetIdCleaned_Mu5"),
